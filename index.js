...
function convert() {
  ...
  meterElement.textContent =
    inputValue +
    " meters =  " +
    meter.toFixed(3).toString() +
    " feet |" +
    inputValue +
    " feet = " +
    feet.toFixed(3).toString() +
    " meters";
  literElement.textContent =
    inputValue +
    " liters =  " +
    liter.toFixed(3).toString() +
    " gallon |" +
    inputValue +
    " gallons = " +
    gallon.toFixed(3).toString() +
    " liters";
  kilogramElement.textContent =
    inputValue +
    " kilograms =  " +
    kilogram.toFixed(3).toString() +
    " pound |" +
    inputValue +
    " pounds = " +
    pound.toFixed(3).toString() +
    " kilogram";
